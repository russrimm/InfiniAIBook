...
def paste_hand(frame_u8, pos):
    ...
    # The hand enters from the lower right and, unclipped, reaches across the
    # caption band and hides the words underneath it. Restore everything below
    # the band line so the caption is always readable.
    band_top = ART_H + 20
    out[band_top:] = frame_u8[band_top:]
    return out
